...
final class ConstantCouldNotBeReflected extends \RuntimeException implements Exception
{
    public static function forConstantLocationWithReflectionException(
